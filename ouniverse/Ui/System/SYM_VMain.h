...
#include "SYM_VMain.generated.h"

class UserLibC;
class LoadoutLibC;

UCLASS(Blueprintable)
class OUNIVERSE_API USYM_VMain : public UUi_View
{
...
public:
	...
	static USYM_VMain* Create(UUi_View* InParentView, UserLibC* InUserLib, LoadoutLibC* InLoadoutLib);

	void Init(UUi_View* InParentView, UserLibC* InUserLib, LoadoutLibC* InLoadoutLib);
