...
#include "SYM_Main.generated.h"

class UserLibC;
class LoadoutLibC;

UCLASS(Blueprintable)
class OUNIVERSE_API USYM_Main : public UUi_View
{
...
public:
	...
	static USYM_Main* Create(UUi_View* InParentView, UserLibC* InUserLib, LoadoutLibC* InLoadoutLib);
