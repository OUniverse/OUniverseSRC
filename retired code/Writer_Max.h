...
#include "Writer_Max.generated.h"

class UAtlas;
class AtlasLibC;

UENUM(BlueprintType)		//"BlueprintType" is essential to include
enum class EWriterCMD : uint8
{
	DoThing 		UMETA(DisplayName = "Dance"),
	DoOtherThing 	UMETA(DisplayName = "Rain"),
	SomethingElse	UMETA(DisplayName = "Song")
};

UCLASS(Blueprintable)
class OUNIVERSE_API UWriter_Max : public UUi_Master
{
...
public:
	...
	static UWriter_Max* Create(UWorld* InScope, AtlasLibC* InAtlasLib);
